                        ...
                        <table class="table table-borderless table-striped dfTable table-right-left">
                            <tbody>
                                ...
                                <tr>
                                   ...
                                   <tr>
                                    <td>Total Cost</td>
                                    <td><?= $this->tec->formatNumber(($product->quantity == 0) ? 1 *$product->cost : $product->quantity*$product->cost); ?></td>
                                </tr>
                                   <tr>
                                    <td>Total Price</td>
                                    <td><?= $this->tec->formatNumber(($product->quantity == 0) ? 1 *$product->price : $product->quantity*$product->price); ?></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
