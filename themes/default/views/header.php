                ...
                <li class="treeview mm_categories">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li id="categories_add"><a href="<?= site_url('categories/add'); ?>"><i class="fa fa-circle-o"></i> <?= lang('add_category'); ?></a></li>
                          <li id="sellas_list"><a href="<?= site_url('sellas'); ?>"><i class="fa fa-circle-o"></i> List Sell Product As</a></li>
                          <li id="categorie_add"><a href="<?= site_url('sellas/add'); ?>"><i class="fa fa-circle-o"></i> Sell Product As</a></li>
