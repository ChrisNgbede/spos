                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li style="background-color: beige;">
                                <a href="#" data-toggle="control-sidebar" class="sidebar-icon"><i class="fa fa-folder sidebar-icon"></i> Open Categories</a>
                            </li>
                        </ul>
                    </div>
                </nav>
                                                ...
                                                <table class="table table-striped table-condensed table-hover list-table" style="margin:0;">
                                                    <thead>
                                                        <tr class="success">
                                                            ...
                                                            <th style="width: 15%;text-align:center;">Sell As</th>
                                            ...
                                            <table id="posTable" class="table table-striped table-condensed table-hover list-table" style="margin:0px;" data-height="100">
                                                <thead>
                                                    <tr class="success">
                                                        ...
                                                        <th style="width: 15px;" class="satu"><i class="fa fa-trash-o"></i></th>
                                                    </tr>
                                                </thead>
                                                <tbody></tbody>
                                            </table>
                    ...
                    <div id="category-sidebar-menu">
                        <ul class="control-sidebar-menu">
                            ...
                            foreach($categories as $category) {
                                ...
                                echo '<div class="menu-info"><h5 style="color:#fff;">'.$category->name.'</h5></div>
                            </a></li>';
                        }
                        ?>
                    </ul>
